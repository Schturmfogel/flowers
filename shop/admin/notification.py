...
from shop.models.notifiation import Notification, NotificationAttachment
...
class NotificationAdmin(admin.ModelAdmin):
    ...
    num.attachments.short_description = _("Attachments")
    ...
    def recipient(self, obj):
        ...
        except (get_user_model().DoesNotExists, KeyError):
            return _("Nobody")
