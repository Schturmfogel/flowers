...
from django.template import engines, TemplateDoesNotExists
...
class BreadcrumbPlugin(ShopPluginBase):
	name = _("Breadcrumb")
	CHOICES = (('default', _("Default Bradcrumb")), ('soft-root', _("`Soft-Root` Breadcrumb")),
	...
	def get_identifier(cls, instance):
		render_type = instance.glosssary.get('render_type')
